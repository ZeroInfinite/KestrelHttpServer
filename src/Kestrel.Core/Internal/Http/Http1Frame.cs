...
{
    public abstract partial class Http1Frame : Frame
    {
        ...
        public Http1Frame(FrameContext context)
            : base(context)
        {
            _context = context;
            ...
            Output = new OutputProducer(_context.Application.Input, _context.Transport.Output, _context.ConnectionId, _context.ServiceContext.Log, _context.TimeoutControl);
        }
